...
```{r, echo=FALSE, fig.width=6, fig.height=4, out.width="45%", fig.show="hold"}
plot(dem, main = "input", text_values = TRUE, breaks = "equal", col = terrain.colors(10), useRaster = TRUE)
plot(dem, col = rep(NA, 3), key.pos = NULL, main = "", useRaster = TRUE)
plot(round(dem_mean3, 1), main = "mean (k=3)", text_values = TRUE, breaks = "equal", col = terrain.colors(10), useRaster = TRUE)
plot(dem_sum3, main = "sum (k=3)", text_values = TRUE, breaks = "equal", col = terrain.colors(10), useRaster = TRUE)
plot(dem_min3, main = "min (k=3)", text_values = TRUE, breaks = "equal", col = terrain.colors(10), useRaster = TRUE)
plot(dem_max3, main = "max (k=3)", text_values = TRUE, breaks = "equal", col = terrain.colors(10), useRaster = TRUE)
```
...
```{r, echo=FALSE, fig.width=4, fig.height=6, out.width="30%", fig.show="hold"}
plot(carmel, main = "input", breaks = "equal", col = terrain.colors(10), useRaster = TRUE)
plot(carmel_mean9, main = "mean (k=9)", breaks = "equal", col = terrain.colors(10), useRaster = TRUE)
plot(carmel_mean27, main = "mean (k=27)", breaks = "equal", col = terrain.colors(10), useRaster = TRUE)
```
...
```{r, echo=FALSE, fig.width=4, fig.height=6, out.width="45%", fig.show="hold"}
plot(carmel, breaks = "equal", col = terrain.colors(11), useRaster = TRUE)
plot(carmel_slope, breaks = "equal", col = hcl.colors(11, "Spectral"), useRaster = TRUE)
```
...
```{r, echo=FALSE, fig.width=4, fig.height=6, out.width="45%", fig.show="hold"}
plot(carmel, breaks = "equal", col = terrain.colors(11), useRaster = TRUE)
plot(carmel_aspect, breaks = "equal", col = hcl.colors(11, "Spectral"), useRaster = TRUE)
```
...
```{r, echo=FALSE, fig.width=4, fig.height=6, out.width="30%", fig.show="hold"}
plot(golan, breaks = "equal", col = terrain.colors(11), useRaster = TRUE)
plot(golan_asp, breaks = "equal", col = hcl.colors(11, "Spectral"), useRaster = TRUE)
plot(golan_ci, breaks = "equal", col = hcl.colors(11, "Spectral"), useRaster = TRUE)
```
